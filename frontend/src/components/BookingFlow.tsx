...
import { IconArrowLeft, IconCheck, IconClock, IconUser } from './icons/Icons';

const DAYS = ['Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam', 'Dim'];
const TIME_SLOTS = ['09:00', '09:30', '10:00', '10:30', '11:00', '11:30', '14:00', '14:30', '15:00', '15:30', '16:00', '16:30'];

export default function BookingFlow() {
  const { selectedPro, navigateTo, setCurrentBooking } = useAppContext();
  ...
  const stepTitles = ['Choisir un service', 'Lieu de prestation', 'Date et heure', 'Vos coordonnees', 'Confirmation'];
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={() => step > 1 ? setStep(s => s - 1) : navigateTo('proFiche')}
          style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '4px' }}
        >
          <IconArrowLeft size={22} color="rgba(255,255,255,0.6)" />
        </button>
        <div style={{ flex: 1 }}>
          <div
            style={{
      ...
      {/* PROGRESS BAR */}
      <div style={{ flexShrink: 0, height: '3px', background: 'rgba(255,255,255,0.08)', position: 'relative' }}>
        <div
          style={{
            height: '100%',
            background: '#F2D06B',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {services.map((service, i) => (
                <button
                  ...
                  style={{
                    width: '100%',
                    background: selectedService === i ? 'rgba(242,208,107,0.08)' : 'rgba(255,255,255,0.04)',
                ...
                >
                  <div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <IconClock size={12} color="rgba(255,255,255,0.4)" />
                      <span
                        style={{
                          fontFamily: 'Inter, sans-serif',
                          fontSize: '12px',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
                ...
                <button
                  ...
                  style={{
                    width: '100%',
                    background: location === opt.id ? 'rgba(242,208,107,0.08)' : 'rgba(255,255,255,0.04)',
                ...
                >
                  <div
                    style={{
                      ...
                      height: '52px',
                      borderRadius: '14px',
                      background: location === opt.id ? 'rgba(242,208,107,0.12)' : 'rgba(255,255,255,0.06)',
                      display: 'flex',
                      alignItems: 'center',
                  ...
                  >
                    <IconUser size={24} color={location === opt.id ? '#F2D06B' : 'rgba(255,255,255,0.5)'} />
                  </div>
                  <div>
                    <div
                      style={{
                        ...
                        fontWeight: 700,
                        fontSize: '16px',
                        color: location === opt.id ? '#F2D06B' : '#F4F4F8',
                        marginBottom: '4px',
                      }}
                    >
                      {opt.label}
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      height: '72px',
                      borderRadius: '14px',
                      background: selectedDay === i ? '#F2D06B' : 'rgba(255,255,255,0.04)',
                  ...
                  >
                    <span
                      style={{
                        ...
                        fontWeight: 500,
                        fontSize: '11px',
                        color: selectedDay === i ? '#050507' : 'rgba(255,255,255,0.4)',
                      }}
                    >
                      {info.day}
                    </span>
                    <span
                      style={{
                        ...
                        fontWeight: 700,
                        fontSize: '18px',
                        color: selectedDay === i ? '#050507' : '#F4F4F8',
                      }}
                    >
                      {info.date}
                    </span>
              ...
              {TIME_SLOTS.map(slot => (
                <button
                  ...
                  style={{
                    height: '44px',
                    borderRadius: '12px',
                    background: selectedTime === slot ? '#F2D06B' : 'rgba(255,255,255,0.04)',
                    border: `1px solid ${selectedTime === slot ? '#F2D06B' : 'rgba(255,255,255,0.06)'}`,
                    color: selectedTime === slot ? '#050507' : 'rgba(255,255,255,0.7)',
                    fontFamily: 'Inter, sans-serif',
          ...
          <div>
            ...
            >
              ...
              >
                ...
                >
                  {services[selectedService ?? 0]?.prix ?? 0} CHF
                </span>
              </div>
            </div>
          </div>
      ...
      >
        <button
          ...
          style={{
            width: '100%',
            height: '56px',
            background: canProceed() ? '#F2D06B' : 'rgba(242,208,107,0.3)',
            color: canProceed() ? '#050507' : 'rgba(5,5,7,0.5)',
            border: 'none',
            borderRadius: '16px',
            fontFamily: 'Inter, sans-serif',
            fontWeight: 800,

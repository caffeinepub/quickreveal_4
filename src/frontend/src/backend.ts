...
export class Backend implements backendInterface {
    ...
    async addCrib(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCrib(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async cancelReservation(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllCribs(): Promise<Array<BabyCribView>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCribs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCrib(arg0: string): Promise<BabyCribView> {
        if (this.processError) {
            try {
                const result = await this.actor.getCrib(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeCribs(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeCribs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeServices(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeServices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeCrib(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeCrib(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reserveCrib(arg0: Principal, arg1: string, arg2: string, arg3: Time): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.reserveCrib(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async spendLoyaltyPoints(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.spendLoyaltyPoints(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
